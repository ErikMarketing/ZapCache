...
Simple WordPress plugin that adds a cache clearing button to your admin bar. Extra features that works with Hostinger, Kinsta, SiteGround, Cloudways, WP Engine, and major caching plugins.
